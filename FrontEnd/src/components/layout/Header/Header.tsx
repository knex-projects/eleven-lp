  ...
  return (
    <section className="z-[1] w-screen backdrop-blur-lg bg-background-muted fixed top-0 grid justify-items-center content-center max-[760px]">
      ...
      <Popover open={isMenuOpen} onOpenChange={setIsMenuOpen}>
        <PopoverTrigger 
          className="absolute right-5 top-3 pb-2 min-md:hidden"
        ...
        <PopoverContent className="w-[100vw] min-[761px]:hidden backdrop-blur-lg bg-[#6C6C6C40] border-b-[1px] border-t-[1px] border-background-muted border-l-0 border-r-0 rounded-none text-primary-text text-center grid text-[24px] p-0">
          <nav>
            ...
            <h1 className="border-b-[1px] h-[52px] content-center border-background-muted">
              <Link to="/Solucoes" onClick={() => setIsMenuOpen(false)}>Soluções</Link>
            </h1>
            <h1 className="border-b-[1px] h-[52px] content-center border-background-muted">
              <Link to="/Materiais" onClick={() => setIsMenuOpen(false)}>Materiais gratuitos</Link>
            </h1>
            <h1 className="border-b-[1px] h-[52px] content-center border-background-muted">
              <Link to="/Cases" onClick={() => setIsMenuOpen(false)}>Cases</Link>
            </h1>
            <h1 className="border-b-[1px] h-[52px] content-center border-background-muted">
