...
export default function MaterialsSection(){
    return(
        <section>
            <div className="relative w-full h-[870px]  bg-cover bg-center  max-md:h-[745px]  text-white flex justify-evenly items-center pt-[280px] "  style={{ backgroundImage: `url(${background})`}}>
                 <div className="w-[78%]">
        <div className="">
          ...
          <h2 className="text-[24px] font-normal  max-w-[522px] pt-10 text-subtext w-[100%] max-sm:max-w-[275px] max-sm:text-[16px] max-md:text-start">
