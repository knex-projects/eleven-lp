...
export default function MissionSection() {
  return (
    <section className="bg-dark-background w-screen flex items-center max-md:justify-center min-md:justify-evenly max-lg:flex-col p-15">
      <div className="">
        <h1 className="text-primary-text text-[45px] pb-5 font-bold max-w-[655px] max-lg:max-w-[390px] max-lg:text-[32px]">
          A nossa missão como empresa{" "}
          <span className="text-emphasis">júnior</span>
        </h1>
        <p className="text-justify text-subtext text-[20px] max-w-[655px] max-lg:max-w-[390px]">
      ...
      <img src={rocketIcon} className="w-[400px] max-lg:mt-10" />
    </section>
  );
}
